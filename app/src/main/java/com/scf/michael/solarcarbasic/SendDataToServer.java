...
public class SendDataToServer {
    ...
    public void sendDatum(Context context){

        checkLogs(context,1);
    }

    public void sendData(Context context, Integer numOfRecords){

        checkLogs(context,numOfRecords);
    }

    public void sendSlowData(Context context, Integer numOfRecords) {
    ...
    public void checkLogs(Context context, Integer numOfRecords){
        ...
        while (newLoc != null && newLoc.getUpdatedAt() != null && senttoservercnt<numOfRecords) {
            //Toast.makeText(context, "here", Toast.LENGTH_SHORT).show();
